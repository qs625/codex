...
impl TurnContext {
    ...
    pub(crate) fn resolve_exec_command_environment(
        ...
        environment_id: Option<&str>,
        workdir: Option<&str>,
    ) -> Result<Option<codex_sandboxing_api::ResolvedExecCommandEnvironment>, FunctionCallError>
    {
        let environment = environment_id.map_or_else(
            || Ok(self.environments.primary()),
            |environment_id| {
    ...
    pub(crate) fn tool_sandbox_context(&self) -> codex_sandboxing_api::ToolSandboxContext {
        codex_sandboxing_api::ToolSandboxContext {
    ...
    pub(crate) fn base_tool_result_tags(&self) -> thread_service_api::ToolTelemetryTags {
        vec![
            (
                "sandbox",
...
impl thread_service_api::ThreadCapability for TurnContext {
