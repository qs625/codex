...
use codex_mcp_runtime::OpenAiFilePathResolver;
...
pub(crate) async fn rewrite_mcp_tool_arguments_for_openai_files(
    ...
    let path_resolver = TurnContextOpenAiFilePathResolver { turn_context };
    codex_mcp_runtime::rewrite_mcp_tool_arguments_for_openai_files(
        sess.services.openai_file_uploader.as_ref(),
        auth.as_ref(),
...
struct TurnContextOpenAiFilePathResolver<'a> {
    turn_context: &'a TurnContext,
}

impl OpenAiFilePathResolver for TurnContextOpenAiFilePathResolver<'_> {
