...
use config_service::SandboxModeRequirement;
...
mod tests {
    ...
    use config_service::ConstrainedWithSource;
    use config_service::FeatureRequirementsToml;
    use config_service::FilesystemConstraints;
    use config_service::McpServerIdentity;
    use config_service::McpServerRequirement;
    use config_service::NetworkConstraints;
    use config_service::NetworkDomainPermissionToml;
