...
use app_server_protocol::HookOutputEntry;
use app_server_protocol::HookOutputEntryKind;
use app_server_protocol::HookRunStatus;
use app_server_protocol::HookRunSummary;
use ratatui::prelude::*;
