...
impl ChatWidget {
    pub(super) fn on_hook_started(&mut self, run: app_server_protocol::HookRunSummary) {
    ...
    pub(super) fn on_hook_completed(&mut self, completed: app_server_protocol::HookRunSummary) {
