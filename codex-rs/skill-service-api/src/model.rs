...
/// File-system path watched for skill changes.
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct SkillWatchPath {
    pub path: PathBuf,
    pub recursive: bool,
}
...
impl SkillLoadOutcome {
    ...
    pub fn set_load_context(
        ...
        self.skill_root_by_path = Arc::new(skill_root_by_path);
        self.file_systems_by_skill_path = SkillFileSystemsByPath::new(file_systems_by_skill_path);
    }
