...
pub type SkillServiceApiFuture<'a, T> = Pin<Box<dyn Future<Output = T> + Send + 'a>>;
...
pub trait SkillServiceApi: Send + Sync {
...
pub type SharedSkillServiceApi = Arc<dyn SkillServiceApi>;

pub struct DisabledSkillService;

impl SkillServiceApi for DisabledSkillService {
    fn skills_for_config<'a>(
        &'a self,
