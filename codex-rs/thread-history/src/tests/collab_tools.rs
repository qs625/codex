            ...
            ThreadItem::CollabAgentToolCall {
                ...
                agents_states: [(
                    ...
                    CollabAgentState {
                        ...
                        status: app_server_protocol::CollabAgentStatus::Completed,
                        message: None,
                    },
                )]
                .into_iter()
        ...
        assert_eq!(
            ...
            ThreadItem::CollabAgentToolCall {
                ...
                agents_states: [(
                    ...
                    CollabAgentState {
                        path: Some("/root/scout".into()),
                        status: app_server_protocol::CollabAgentStatus::Running,
                        message: None,
                    },
                )]
                .into_iter()
        ...
        assert_eq!(
            ...
            ThreadItem::CollabAgentToolCall {
                ...
                agents_states: [(
                    ...
                    CollabAgentState {
                        path: Some("/root/scout".into()),
                        status: app_server_protocol::CollabAgentStatus::Interrupted,
                        message: None,
                    },
                )]
                .into_iter()
