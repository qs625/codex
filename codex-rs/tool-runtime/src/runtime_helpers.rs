...
pub fn exec_env_for_sandbox_permissions(
    env: &HashMap<String, String>,
...
pub fn disable_powershell_profile_for_elevated_windows_sandbox(
    command: &[String],
...
/// POSIX-only helper: for commands produced by shell exec-arg derivation for
/// Bash/Zsh/sh of the form `[shell_path, "-lc", "<script>"]`, and when a
