//! Lightweight exec-server JSON-RPC protocol DTOs.
//!
//! This crate owns wire-shaped request, response, and notification types shared
//! by exec-server clients and runtime adapters. It intentionally does not own
//! process spawning, environment management, HTTP transport, or filesystem
//! implementations.
