...
pub use metrics_api::CURATED_PLUGINS_STARTUP_SYNC_FINAL_METRIC;
pub use metrics_api::CURATED_PLUGINS_STARTUP_SYNC_METRIC;
pub use metrics_api::MULTI_AGENT_NICKNAME_POOL_RESET_METRIC;
pub use metrics_api::THREAD_SKILLS_DESCRIPTION_TRUNCATED_CHARS_METRIC;
pub use metrics_api::THREAD_SKILLS_ENABLED_TOTAL_METRIC;
pub use metrics_api::THREAD_SKILLS_KEPT_TOTAL_METRIC;
pub use metrics_api::THREAD_SKILLS_TRUNCATED_METRIC;
pub use names::*;
use std::sync::Arc;
...
pub(crate) fn install_global(metrics: MetricsClient) {
    let _ = metrics_api::install_global_metrics(Arc::new(metrics.clone()));
