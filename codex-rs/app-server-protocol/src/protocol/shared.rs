...
macro_rules! camel_case_enum_from_core {
    (
        $(#[$enum_meta:meta])*
...
pub(super) use camel_case_enum_from_core;
...
pub enum CodexErrorInfo {
    ...
    HttpConnectionFailed {
        ...
        #[cfg_attr(feature = "schema-export", ts(rename = "httpStatusCode"))]
    ...
    ActiveTurnNotSteerable {
        ...
        #[cfg_attr(feature = "schema-export", ts(rename = "turnKind"))]
...
#[cfg_attr(feature = "schema-export", derive(JsonSchema, TS))]
#[derive(
    Serialize, Deserialize, Debug, Clone, Copy, PartialEq, Eq, ExperimentalApi,
)]
#[serde(rename_all = "kebab-case")]
#[cfg_attr(feature = "schema-export", ts(rename_all = "kebab-case"))]
pub enum AskForApproval {
    #[serde(rename = "untrusted")]
    #[cfg_attr(feature = "schema-export", ts(rename = "untrusted"))]
    UnlessTrusted,
    OnFailure,
    OnRequest,
...
#[cfg_attr(feature = "schema-export", derive(TS))]
#[derive(Serialize, Deserialize, Debug, Clone, Copy, PartialEq, Eq)]
#[cfg_attr(feature = "schema-export", ts(
