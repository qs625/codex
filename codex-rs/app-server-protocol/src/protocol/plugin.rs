...
pub enum PluginListMarketplaceKind {
    #[serde(rename = "local")]
    #[cfg_attr(feature = "schema-export", ts(rename = "local"))]
    Local,
    #[serde(rename = "workspace-directory")]
    #[cfg_attr(feature = "schema-export", ts(rename = "workspace-directory"))]
    WorkspaceDirectory,
    #[serde(rename = "shared-with-me")]
    #[cfg_attr(feature = "schema-export", ts(rename = "shared-with-me"))]
    SharedWithMe,
}
...
pub enum PluginShareDiscoverability {
    #[serde(rename = "LISTED")]
    #[cfg_attr(feature = "schema-export", ts(rename = "LISTED"))]
    Listed,
    #[serde(rename = "UNLISTED")]
    #[cfg_attr(feature = "schema-export", ts(rename = "UNLISTED"))]
    Unlisted,
    #[serde(rename = "PRIVATE")]
    #[cfg_attr(feature = "schema-export", ts(rename = "PRIVATE"))]
    Private,
}
...
pub enum PluginSharePrincipalType {
    #[serde(rename = "user")]
    #[cfg_attr(feature = "schema-export", ts(rename = "user"))]
    User,
    #[serde(rename = "group")]
    #[cfg_attr(feature = "schema-export", ts(rename = "group"))]
    Group,
    #[serde(rename = "workspace")]
    #[cfg_attr(feature = "schema-export", ts(rename = "workspace"))]
    Workspace,
}
...
pub struct SkillToolDependency {
    #[serde(rename = "type")]
    #[cfg_attr(feature = "schema-export", ts(rename = "type"))]
    pub r#type: String,
    pub value: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[cfg_attr(feature = "schema-export", ts(optional))]
...
impl From<CoreSkillMetadata> for SkillMetadata {
    fn from(value: CoreSkillMetadata) -> Self {
        Self {
            ...
            interface: value.interface.map(skill_interface_from_core),
