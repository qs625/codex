...
export type ResponseItem = { "type": "command_wait", command_id: string, status: CommandWaitStatus, notification: CommandWaitNotificationKind | null, exit_code: number | null, wall_time_seconds: number, created_at_ms: bigint, } | { "type": "command_write_stdin", command_id: string, bytes_written: number, contains_newline: boolean, created_at_ms: bigint, } | { "type": "command_execution_notification", command_item_id: string, kind: CommandExecutionNotificationKind, message: string, output: string | null, exit_code: number | null, created_at_ms: bigint, } | { "type": "workflow_run_progress", event: WorkflowRunProgressEvent, } | { "type": "event_command_event", event: EventCommandEvent, } | { "type": "event_driven_tool", trigger: EventDrivenToolTrigger, } | { "type": "inter_agent_communication", communication: InterAgentCommunication, } | { "type": "thread_goal_update", goal: ThreadGoalUpdateGoal, action: ThreadGoalUpdateEventAction, source: ThreadGoalUpdateEventSource, previous_status?: ThreadGoalUpdateGoalStatus, } | { "type": "message", role: string, content: Array<ContentItem>, phase?: MessagePhase, } | { "type": "reasoning", summary: Array<ReasoningItemReasoningSummary>, content?: Array<ReasoningItemContent>, encrypted_content: string | null, } | { "type": "local_shell_call",
/**
