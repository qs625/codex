...
pub(crate) async fn emit_unified_exec_begin(
    ...
    session_ref.send_exec_command_begin(turn_ref.as_ref(), ExecCommandBeginEvent {
...
pub(crate) async fn emit_unified_exec_end_with_output(
    ...
    session_ref.send_exec_command_end(turn_ref.as_ref(), ExecCommandEndEvent {
    ...
    if process_id.is_some() {
        session_ref.record_model_items_and_emit_display_events(turn_ref.as_ref(), &[
