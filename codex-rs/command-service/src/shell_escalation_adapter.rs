...
use crate::tool_runtime_support::PermissionRequestPayload;
...
use crate::tool_runtime_support::permission_request_hook_payload;
...
pub(super) async fn try_run_zsh_fork(
    ...
    let env =
        codex_tool_runtime::exec_env_for_sandbox_permissions(&req.env, req.sandbox_permissions);
    let command =
        codex_tool_runtime::build_sandbox_command(
            command,
            &req.cwd,
            &env,
