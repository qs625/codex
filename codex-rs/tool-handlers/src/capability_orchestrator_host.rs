...
pub struct CapabilityToolOrchestratorHost;

impl<Session, Turn>
    ToolOrchestratorHost<Arc<Session>, Turn, ToolRuntimeNetworkApprovalTrigger>
    for CapabilityToolOrchestratorHost
where
    ...
    Turn: ToolRuntimeTurnCapability,
{
    ...
    fn begin_network_approval<'a>(
        ...
        spec: Option<codex_tool_runtime_api::NetworkApprovalSpec<ToolRuntimeNetworkApprovalTrigger>>,
