...
pub(crate) struct TypedToolSpecRequest<'a> {
    ...
    pub(crate) session_command_interaction:
        Arc<dyn command_service_api::SessionCommandInteractionCaller>,
    ...
    pub(crate) params: tool_service_api::ToolServiceParams<'a>,
}
...
impl Clone for TypedToolSpecRequest<'_> {
    fn clone(&self) -> Self {
        Self {
            ...
            params: tool_service_api::ToolServiceParams {
