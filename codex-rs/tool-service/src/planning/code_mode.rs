            ...
            for tool in &mut namespace.tools {
                match tool {
                    ResponsesApiNamespaceTool::Function(tool) => {
                        ...
                        tool.description =
                            codex_code_mode_api::augment_tool_definition(definition).description;
                    }
                }
            }
...
pub fn tool_spec_to_code_mode_tool_definition(spec: &ToolSpec) -> Option<CodeModeToolDefinition> {
    ...
    codex_code_mode_api::is_code_mode_nested_tool(&definition.name)
        .then(|| codex_code_mode_api::augment_tool_definition(definition))
}
