...
use app_server_protocol::AgentType;
use app_server_protocol::AgentTypeListParams;
use app_server_protocol::AgentTypeListResponse;
...
use app_server_protocol::TerminalSessionControlResponse;
...
use app_server_protocol::ThreadProviderCapabilities;
use app_server_protocol::ThreadProviderDescriptor;
use app_server_protocol::ThreadProviderKind;
use app_server_protocol::ThreadProviderListParams;
use app_server_protocol::ThreadProviderListResponse;
use app_server_protocol::ThreadProviderModelSelection;
...
fn is_external_cli_thread_provider_id(id: &str) -> bool {
    thread_service_api::ExternalRootThreadProvider::from_provider_id(id).is_some()
}
