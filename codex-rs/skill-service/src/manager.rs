...
use skill_service_api::SkillServiceApi;
use skill_service_api::SkillServiceApiFuture;
use skill_service_api::SkillsLoadInput;
use skill_service_api::build_implicit_skill_path_indexes;
use skill_service_api::bundled_skills_enabled_from_stack;
use skill_service_api::config_rules::SkillConfigRules;
...
impl SkillServiceApi for SkillService {
    fn skills_for_config<'a>(
        &'a self,
        input: &'a SkillsLoadInput,
        fs: Option<Arc<dyn ExecutorFileSystem>>,
    ) -> SkillServiceApiFuture<'a, SkillLoadOutcome> {
    ...
    fn skill_root_paths_for_config<'a>(
        ...
        input: &'a SkillsLoadInput,
        fs: Option<Arc<dyn ExecutorFileSystem>>,
    ) -> SkillServiceApiFuture<'a, Vec<AbsolutePathBuf>> {
        Box::pin(async move {
