...
use codex_session_runtime::Mailbox;
use codex_session_runtime::MailboxDeliveryPhase;
use codex_session_runtime::MailboxReceiver;
use codex_session_runtime::PendingInputItem;
...
pub(crate) struct CodexSpawnArgs {
    ...
    pub(crate) tool_router_factory: Arc<crate::CoreToolRouterFactory>,
...
impl Session {
    ...
    pub(crate) fn tool_user_shell_type(&self) -> codex_tool_config::ToolUserShellType {
        crate::tools::runtimes::runtime_shell_type(&self.user_shell().shell_type)
    }

    pub(crate) fn runtime_shell(&self) -> codex_tool_runtime_api::RuntimeShell {
        crate::tools::runtimes::runtime_shell(self.user_shell().as_ref())
    }
    ...
    pub(crate) async fn account_goal_tool_completed(
        ...
        self.goal_runtime_apply(GoalRuntimeEvent::ToolCompleted {
            turn_context: turn,
    ...
    pub async fn run_unified_exec_command(
        ...
        let context =
            crate::unified_exec::UnifiedExecContext::new(Arc::clone(self), turn.clone(), call_id);
        let response = self
            .services
            .unified_exec_manager
            .exec_command(
                crate::unified_exec::ExecCommandRequest {
                    ...
                    shell_type: tool_user_shell_type_to_core_shell_type(&request.shell_type),
