...
use crate::apply_patch_tool_host::CoreApplyPatchHandlerHost;
...
#[cfg(any(test, feature = "test-support"))]
pub(crate) fn core_apply_patch_handler_host() -> CoreApplyPatchHandlerHost {
    fn assert_tool_domain_host<Host: codex_tool_runtime_api::ToolDomainHost>(host: Host) -> Host {
        host
    }

    assert_tool_domain_host(CoreApplyPatchHandlerHost)
}
