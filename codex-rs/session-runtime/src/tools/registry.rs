...
pub struct CoreToolDispatchHost;
...
impl ToolDispatchHost<ToolInvocation> for CoreToolDispatchHost {
    ...
    async fn run_post_tool_use_hooks(
        ...
        let outcome = invocation
            .session
            .run_post_tool_use_hooks_for_turn(invocation.turn.as_ref(), payload)
            .await;
    ...
    async fn account_goal_tool_completed(
        ...
        invocation
            .session
            .account_goal_tool_completed(invocation.turn.as_ref(), tool_name)
            .await
    }
}
