...
use codex_session_api::SessionGoalCaller;

impl SessionGoalCaller<Arc<TurnContext>> for Session {
    async fn get_thread_goal(self: Arc<Self>) -> Result<Option<ThreadGoal>, String> {
        Session::get_thread_goal(self.as_ref())
            .await
    ...
    async fn complete_thread_goal(
        ...
        self.goal_runtime_apply(GoalRuntimeEvent::ToolCompletedGoal {
