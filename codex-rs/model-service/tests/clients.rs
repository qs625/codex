...
use http::StatusCode;
use model_service::ChatCompletionsClient;
use model_service::ResponsesClient;
use model_service_api::ApiError;
use model_service_api::AuthError;
use model_service_api::AuthProvider;
use model_service_api::AuthProviderFuture;
use model_service_api::ChatCompletionsPath;
