use crate::realtime_websocket::methods_v1::conversation_handoff_append_message as v1_conversation_handoff_append_message;
use crate::realtime_websocket::methods_v1::conversation_item_create_message as v1_conversation_item_create_message;
use crate::realtime_websocket::methods_v1::session_update_session as v1_session_update_session;
use crate::realtime_websocket::methods_v1::websocket_intent as v1_websocket_intent;
use crate::realtime_websocket::methods_v2::conversation_function_call_output_message as v2_conversation_function_call_output_message;
use crate::realtime_websocket::methods_v2::conversation_item_create_message as v2_conversation_item_create_message;
use crate::realtime_websocket::methods_v2::session_update_session as v2_session_update_session;
use crate::realtime_websocket::methods_v2::websocket_intent as v2_websocket_intent;
...
pub fn session_update_session_json(config: RealtimeSessionConfig) -> JsonResult<Value> {
    model_service_api::session_update_session_json(config)
}
