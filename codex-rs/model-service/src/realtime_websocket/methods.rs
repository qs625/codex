use crate::realtime_websocket::methods_common::conversation_function_call_output_message;
use crate::realtime_websocket::methods_common::conversation_item_create_message;
use crate::realtime_websocket::methods_common::normalized_session_mode;
use crate::realtime_websocket::methods_common::session_accepts_top_level_model;
use crate::realtime_websocket::methods_common::session_update_session;
use crate::realtime_websocket::methods_common::websocket_intent;
use crate::realtime_websocket::protocol::RealtimeAudioFrame;
use crate::realtime_websocket::protocol::RealtimeEvent;
use crate::realtime_websocket::protocol::RealtimeEventParser;
use crate::realtime_websocket::protocol::RealtimeOutboundMessage;
use crate::realtime_websocket::protocol::RealtimeOutputModality;
use crate::realtime_websocket::protocol::RealtimeSessionConfig;
use crate::realtime_websocket::protocol::RealtimeSessionMode;
use crate::realtime_websocket::protocol::RealtimeTranscriptEntry;
use crate::realtime_websocket::protocol::RealtimeVoice;
use crate::realtime_websocket::protocol::parse_realtime_event;
use transport_client::backoff;
...
const REALTIME_WIRE_LOG_TARGET: &str = "model_service::realtime_websocket::wire";
...
mod tests {
    ...
    use protocol::protocol::RealtimeInputAudioSpeechStarted;
    use protocol::protocol::RealtimeNoopRequested;
    use protocol::protocol::RealtimeResponseCancelled;
    use protocol::protocol::RealtimeResponseCreated;
    use protocol::protocol::RealtimeResponseDone;
    use protocol::protocol::RealtimeTranscriptDelta;
    use protocol::protocol::RealtimeTranscriptDone;
