//! Helpers for truncating rollouts based on turn boundaries.
...
/// Return the indices of real user message boundaries in a rollout.
///
...
/// Return a prefix of `items` obtained by cutting strictly before the nth real user message.
///
