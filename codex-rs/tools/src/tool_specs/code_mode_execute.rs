...
"#;
    ...
    ToolSpec::Freeform(FreeformTool {
        name: codex_code_mode_api::PUBLIC_TOOL_NAME.to_string(),
        description: codex_code_mode_api::build_exec_tool_description(
            enabled_tools,
...
mod tests {
    ...
    fn create_code_mode_tool_matches_expected_spec() {
        let enabled_tools = vec![codex_code_mode_api::ToolDefinition {
            name: "update_plan".to_string(),
            tool_name: ToolName::plain("update_plan"),
            description: "Update the plan".to_string(),
            kind: codex_code_mode_api::CodeModeToolKind::Function,
            input_schema: None,
            output_schema: None,
        }];
