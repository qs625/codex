...
/// Returns the on-disk cache location for embedded system skills from an absolute MORPHEUS_HOME.
...
/// Installs embedded system skills into `MORPHEUS_HOME/skills/.system`.
///
