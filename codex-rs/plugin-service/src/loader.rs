...
use skill_service::SkillConfigLayerEntry;
use skill_service::SkillConfigLayerStack;
use skill_service::SkillMetadata;
use skill_service::config_rules::SkillConfigRules;
use skill_service::config_rules::resolve_disabled_skill_paths;
use skill_service::config_rules::skill_config_rules_from_stack;
use skill_service::loader::SkillRoot;
use skill_service::loader::load_skills_from_roots;
...
pub fn log_plugin_load_errors(outcome: &PluginLoadOutcome) {
