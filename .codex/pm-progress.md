...
- id: quarantine-invalid-model-context
  ...
  pending_sync_from_main: final merged-main progress commit pending; dev-2 will be fast-forwarded after this acceptance record
  status: merged
