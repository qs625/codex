...
- id: quarantine-invalid-model-context
  ...
  pending_sync_from_main: PM-only progress commit `227c0bb508`; dev-2 is actively developing from product baseline `483d5bfbe2` and does not need synchronization
  status: in_progress
