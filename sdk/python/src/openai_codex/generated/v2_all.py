...
#   filename:  app_server_protocol.schemas.json
...
class AgentTypeListParams(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    cwd: Annotated[
        str | None,
        Field(description="Workspace path whose config should be used for agent role discovery."),
    ] = None
...
class InitializedClientNotification(BaseModel):
    ...
    method: Annotated[Literal["initialized"], Field(title="InitializedNotificationMethod")]
...
class CollabAgentOperation(Enum):
    unknown = "unknown"
    spawn_agent = "spawnAgent"
    send_message = "sendMessage"
    followup_task = "followupTask"
    child_completion = "childCompletion"
...
class CommandExecutionApprovalDecisionValue(Enum):
    accept = "accept"
...
class CommandExecutionNotificationKind(Enum):
    output = "output"
    exit = "exit"


class CommandExecutionNotifyOn(Enum):
    output = "output"
    exit = "exit"
...
class CommandWaitNotificationKind(Enum):
    output = "output"
    exit = "exit"


class CommandWaitStatus(Enum):
    running = "running"
    completed = "completed"
...
class ConfigLayerSource(
    ...
    root: Annotated[
        ...
        | LegacyManagedConfigTomlFromMdmConfigLayerSource,
        Field(
            description="Identifies a configuration layer and its precedence in the merged config stack."
        ),
    ]
...
class DynamicToolCallResponse(BaseModel):
    ...
    content_items: Annotated[list[DynamicToolCallOutputContentItem], Field(alias="contentItems")]
    success: bool
...
class EventCommandEventKind(Enum):
    output = "output"
    exited = "exited"
    cancelled = "cancelled"
...
class EventDrivenToolTrigger(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    text: str
...
class FileChangeRequestApprovalParams(BaseModel):
    ...
    grant_root: Annotated[str | None, Field(alias="grantRoot")] = None
    item_id: Annotated[str, Field(alias="itemId")]
    reason: str | None = None
...
class InitializeResponse(BaseModel):
    ...
    platform_os: Annotated[
        ...
        Field(
            alias="platformOs",
            description='Operating system for the running app-server target, for example `"macos"` or `"linux"` or `"windows"`.',
        ),
    ]
    user_agent: Annotated[str, Field(alias="userAgent")]


class InjectedContextSection(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    label: str
...
class InterAgentOperation(Enum):
    unknown = "unknown"
    spawn_agent = "spawnAgent"
    send_message = "sendMessage"
    followup_task = "followupTask"
...
class ChatgptDeviceCodeLoginAccountParams(BaseModel):
    ...
    type: Annotated[
        Literal["chatgptDeviceCode"], Field(title="ChatgptDeviceCodeLoginAccountParamsType")
    ]
...
class ChatgptAuthTokensLoginAccountParams(BaseModel):
    ...
    type: Annotated[
        Literal["chatgptAuthTokens"], Field(title="ChatgptAuthTokensLoginAccountParamsType")
    ]
...
class McpServerElicitationRequestResponse(BaseModel):
    ...
    field_meta: Annotated[
        Any | None,
        Field(alias="_meta", description="Optional client metadata for form-mode action handling."),
    ] = None
...
class PluginInterface(BaseModel):
    ...
    composer_icon_url: Annotated[str | None, Field(alias="composerIconUrl")] = None
    default_prompt: Annotated[list[str] | None, Field(alias="defaultPrompt")] = None
    ...
    screenshot_urls: Annotated[list[str], Field(alias="screenshotUrls")]
...
class CommandWaitResponseItem(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    command_id: str
    ...
    id: str | None = None
    notification: CommandWaitNotificationKind | None = None
    status: CommandWaitStatus
    type: Annotated[Literal["command_wait"], Field(title="CommandWaitResponseItemType")]
    wait_timeout_ms: int
    wall_time_seconds: float


class CommandWriteStdinResponseItem(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    ...
    id: str | None = None
    type: Annotated[
        Literal["command_write_stdin"], Field(title="CommandWriteStdinResponseItemType")
    ]


class CommandExecutionNotificationResponseItem(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    command_item_id: str
    ...
    type: Annotated[
        Literal["command_execution_notification"],
        Field(title="CommandExecutionNotificationResponseItemType"),
    ]


class EventDrivenToolResponseItem(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    id: str | None = None
    trigger: EventDrivenToolTrigger
    type: Annotated[Literal["event_driven_tool"], Field(title="EventDrivenToolResponseItemType")]
...
class ThreadApproveGuardianDeniedActionParams(BaseModel):
    ...
    event: Annotated[
        Any, Field(description="Serialized `protocol::protocol::GuardianAssessmentEvent`.")
    ]
    thread_id: Annotated[str, Field(alias="threadId")]
...
class ThreadContextUsageCategoryBreakdown(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    compact: int
    concrete_skills: Annotated[int, Field(alias="concreteSkills")]
    llm_messages: Annotated[int, Field(alias="llmMessages")]
    reasoning: int
    skills_metadata: Annotated[int, Field(alias="skillsMetadata")]
    tool_calls: Annotated[int, Field(alias="toolCalls")]
    tools_metadata: Annotated[int, Field(alias="toolsMetadata")]
    user_messages: Annotated[int, Field(alias="userMessages")]


class ThreadContextUsageToolBucket(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    input: int
...
class ThreadEventCommandEventKind(Enum):
    output = "output"
    exited = "exited"
    cancelled = "cancelled"
...
class ThreadGoalUpdateAction(Enum):
    created = "created"
    updated = "updated"
    paused = "paused"
    resumed = "resumed"
...
class ThreadGoalUpdateEventAction(Enum):
    created = "created"
    updated = "updated"
    paused = "paused"
    resumed = "resumed"
...
class ThreadGoalUpdateEventSource(Enum):
    model_tool = "model_tool"
    client = "client"
    system = "system"


class ThreadGoalUpdateGoalStatus(Enum):
    active = "active"
    paused = "paused"
    budget_limited = "budgetLimited"
    complete = "complete"
...
class ThreadGoalUpdateSource(Enum):
...
class InjectedContextThreadItem(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    id: str
    ...
    title: str
    type: Annotated[Literal["injectedContext"], Field(title="InjectedContextThreadItemType")]
...
class CommandExecutionThreadItem(BaseModel):
    ...
    aggregated_output: Annotated[str | None, Field(alias="aggregatedOutput")] = None
    command: str
    command_actions: Annotated[list[CommandAction], Field(alias="commandActions")]
    cwd: AbsolutePathBuf
    duration_ms: Annotated[int | None, Field(alias="durationMs")] = None
    exit_code: Annotated[int | None, Field(alias="exitCode")] = None
    id: str
    initial_wait_ms: Annotated[int | None, Field(alias="initialWaitMs")] = None
    notify_on: Annotated[CommandExecutionNotifyOn | None, Field(alias="notifyOn")] = None
    process_id: Annotated[str | None, Field(alias="processId")] = None
...
class CommandExecutionNotificationThreadItem(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    command_item_id: Annotated[str, Field(alias="commandItemId")]
    ...
    output: str | None = None
    type: Annotated[
        Literal["commandExecutionNotification"],
        Field(title="CommandExecutionNotificationThreadItemType"),
    ]


class CommandWaitThreadItem(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    ...
    notification: CommandWaitNotificationKind | None = None
    status: CommandWaitStatus
    type: Annotated[Literal["commandWait"], Field(title="CommandWaitThreadItemType")]
    wait_timeout_ms: Annotated[int, Field(alias="waitTimeoutMs")]
    wall_time_seconds: Annotated[float, Field(alias="wallTimeSeconds")]


class CommandWriteStdinThreadItem(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    bytes_written: Annotated[int, Field(alias="bytesWritten", ge=0)]
    command_id: Annotated[str, Field(alias="commandId")]
    contains_newline: Annotated[bool, Field(alias="containsNewline")]
    created_at_ms: Annotated[int, Field(alias="createdAtMs")]
    id: str
    type: Annotated[Literal["commandWriteStdin"], Field(title="CommandWriteStdinThreadItemType")]
...
class BuiltinToolCallThreadItem(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    arguments: Any
    ...
    tool: str
    type: Annotated[Literal["builtinToolCall"], Field(title="BuiltinToolCallThreadItemType")]
...
class EventDrivenToolCallThreadItem(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    arguments: Any
    ...
    tool: str
    type: Annotated[
        Literal["eventDrivenToolCall"], Field(title="EventDrivenToolCallThreadItemType")
    ]


class EventDrivenToolThreadItem(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    id: str
    ...
    title: str
    tool: str
    type: Annotated[Literal["eventDrivenTool"], Field(title="EventDrivenToolThreadItemType")]


class EventCommandCallThreadItem(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    command: str
    ...
    type: Annotated[Literal["eventCommandCall"], Field(title="EventCommandCallThreadItemType")]


class EventCommandEventThreadItem(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    command: str
    ...
    exit_code: Annotated[int | None, Field(alias="exitCode")] = None
    id: str
    kind: ThreadEventCommandEventKind
    label: str | None = None
    line: str | None = None
    ...
    subscription_id: Annotated[str, Field(alias="subscriptionId")]
    truncated: bool
    type: Annotated[Literal["eventCommandEvent"], Field(title="EventCommandEventThreadItemType")]


class CollabAgentMessageThreadItem(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    content: str
    ...
    other_recipient_paths: Annotated[list[str], Field(alias="otherRecipientPaths")]
    recipient_path: Annotated[str, Field(alias="recipientPath")]
    recipient_thread_id: Annotated[str | None, Field(alias="recipientThreadId")] = None
    sender_path: Annotated[str, Field(alias="senderPath")]
    sender_thread_id: Annotated[str | None, Field(alias="senderThreadId")] = None
    trigger_turn: Annotated[bool, Field(alias="triggerTurn")]
    type: Annotated[Literal["collabAgentMessage"], Field(title="CollabAgentMessageThreadItemType")]
...
class CompletedThreadLifecycleFinalStatus(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    last_agent_message: str | None = None
    type: Annotated[Literal["completed"], Field(title="CompletedThreadLifecycleFinalStatusType")]


class ErroredThreadLifecycleFinalStatus(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    message: str | None = None
    type: Annotated[Literal["errored"], Field(title="ErroredThreadLifecycleFinalStatusType")]


class InterruptedThreadLifecycleFinalStatus(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    type: Annotated[
        Literal["interrupted"], Field(title="InterruptedThreadLifecycleFinalStatusType")
    ]


class ShutdownThreadLifecycleFinalStatus(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    type: Annotated[Literal["shutdown"], Field(title="ShutdownThreadLifecycleFinalStatusType")]


class ThreadLifecycleFinalStatus(
    RootModel[
        CompletedThreadLifecycleFinalStatus
        | ErroredThreadLifecycleFinalStatus
        | InterruptedThreadLifecycleFinalStatus
        | ShutdownThreadLifecycleFinalStatus
    ]
):
    model_config = ConfigDict(
        populate_by_name=True,
...
class NotLoadedThreadLifecycleStatus(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    type: Annotated[Literal["notLoaded"], Field(title="NotLoadedThreadLifecycleStatusType")]


class InitializingThreadLifecycleStatus(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    type: Annotated[Literal["initializing"], Field(title="InitializingThreadLifecycleStatusType")]


class ActiveThreadLifecycleStatus(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    active_flags: list[ThreadLifecycleActiveFlag]
    type: Annotated[Literal["active"], Field(title="ActiveThreadLifecycleStatusType")]


class FinalThreadLifecycleStatus(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    result: ThreadLifecycleFinalStatus
    type: Annotated[Literal["final"], Field(title="FinalThreadLifecycleStatusType")]


class SystemErrorThreadLifecycleStatus(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    message: str | None = None
    type: Annotated[Literal["systemError"], Field(title="SystemErrorThreadLifecycleStatusType")]


class ThreadLifecycleWaitReason(Enum):
    child = "child"
    command = "command"
...
class ThreadWorkflowRunProgressKind(Enum):
    started = "started"
    resumed = "resumed"
    completed = "completed"
    failed = "failed"
...
class WorkflowAbortParams(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    reason: str | None = None
...
class WorkflowDescribeParams(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    cwd: str | None = None
...
class WorkflowResumeParams(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
...
class WorkflowRunProgressKind(Enum):
    started = "started"
    resumed = "resumed"
    completed = "completed"
    failed = "failed"
...
class WorkflowSummary(BaseModel):
    ...
    when_to_use: Annotated[list[str], Field(alias="whenToUse")]
...
class AgentTypeListRequest(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    id: RequestId
    method: Annotated[Literal["agentType/list"], Field(title="AgentType/listRequestMethod")]
...
class WorkflowDescribeRequest(BaseModel):
    ...
    id: RequestId
    method: Annotated[Literal["workflow/describe"], Field(title="Workflow/describeRequestMethod")]
...
class WorkflowStatusRequest(BaseModel):
    ...
    id: RequestId
    method: Annotated[Literal["workflow/status"], Field(title="Workflow/statusRequestMethod")]
...
class WorkflowResumeRequest(BaseModel):
    ...
    id: RequestId
    method: Annotated[Literal["workflow/resume"], Field(title="Workflow/resumeRequestMethod")]
    params: WorkflowResumeParams


class WorkflowAbortRequest(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    id: RequestId
    method: Annotated[Literal["workflow/abort"], Field(title="Workflow/abortRequestMethod")]
...
class InterAgentCommunication(BaseModel):
    ...
    other_recipients: list[AgentPath]
    recipient: AgentPath
    recipient_thread_id: ThreadId | None = None
    sender_thread_id: ThreadId | None = None
...
class Model(BaseModel):
    ...
    max_context_window: Annotated[int | None, Field(alias="maxContextWindow")] = None
    model: str
    model_provider: Annotated[str | None, Field(alias="modelProvider")] = None
...
class EventCommandEventResponseItem(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    ...
    id: str | None = None
    type: Annotated[
        Literal["event_command_event"], Field(title="EventCommandEventResponseItemType")
    ]


class InterAgentCommunicationResponseItem(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    ...
    id: str | None = None
    type: Annotated[
        Literal["inter_agent_communication"], Field(title="InterAgentCommunicationResponseItemType")
    ]
...
class ThreadContextUsageSkill(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    kind: ThreadSkillKind
    load_count: Annotated[int, Field(alias="loadCount", ge=0)]
    name: str
    path: str


class ThreadContextUsageToolBreakdown(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    apply_patch: Annotated[ThreadContextUsageToolBucket, Field(alias="applyPatch")]
    commands: ThreadContextUsageToolBucket
    file_operations: Annotated[ThreadContextUsageToolBucket, Field(alias="fileOperations")]
    inter_agent: Annotated[ThreadContextUsageToolBucket, Field(alias="interAgent")]
    other_tools: Annotated[ThreadContextUsageToolBucket, Field(alias="otherTools")]
    search_media: Annotated[ThreadContextUsageToolBucket, Field(alias="searchMedia")]
...
class ThreadGoalUpdateGoal(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    created_at: Annotated[int, Field(alias="createdAt")]
    ...
    thread_id: Annotated[ThreadId, Field(alias="threadId")]
    time_used_seconds: Annotated[int, Field(alias="timeUsedSeconds")]
    token_budget: Annotated[int | None, Field(alias="tokenBudget")] = None
    tokens_used: Annotated[int, Field(alias="tokensUsed")]
    updated_at: Annotated[int, Field(alias="updatedAt")]
...
class ThreadGoalUpdateThreadItem(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    ...
    goal: ThreadGoal
    id: str
    previous_status: Annotated[ThreadGoalStatus | None, Field(alias="previousStatus")] = None
    source: ThreadGoalUpdateSource
    type: Annotated[Literal["threadGoalUpdate"], Field(title="ThreadGoalUpdateThreadItemType")]
...
class WaitingThreadLifecycleStatus(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    reason: ThreadLifecycleWaitReason
    type: Annotated[Literal["waiting"], Field(title="WaitingThreadLifecycleStatusType")]


class ThreadLifecycleStatus(
    RootModel[
        NotLoadedThreadLifecycleStatus
        | InitializingThreadLifecycleStatus
        | ActiveThreadLifecycleStatus
        | WaitingThreadLifecycleStatus
        | FinalThreadLifecycleStatus
        | SystemErrorThreadLifecycleStatus
    ]
):
    model_config = ConfigDict(
        populate_by_name=True,
...
class ThreadSkillsUpdatedNotification(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    skills: list[ThreadSkill]
    thread_id: Annotated[str, Field(alias="threadId")]
...
class ThreadStartParams(BaseModel):
    ...
    task_name: Annotated[str | None, Field(alias="taskName")] = None
    thread_source: Annotated[
        ThreadSource | None,
        Field(
            alias="threadSource",
...
class ThreadStatusChangedNotification(BaseModel):
    ...
    lifecycle_status: Annotated[ThreadLifecycleStatus, Field(alias="lifecycleStatus")]
    thread_id: Annotated[str, Field(alias="threadId")]
...
class ThreadWorkflowRunProgressEvent(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    ...
    message: str
    run_id: Annotated[str, Field(alias="runId")]
    runner_status: Annotated[str, Field(alias="runnerStatus")]
    status: Any
    updated_at: Annotated[int, Field(alias="updatedAt")]
...
class TurnStartParams(BaseModel):
    ...
    model_provider: Annotated[
        ...
        Field(
            alias="modelProvider",
            description="Override the model provider for this turn and subsequent turns.",
        ),
    ] = None
...
class WorkflowRun(BaseModel):
    ...
    abort_reason: Annotated[str | None, Field(alias="abortReason")] = None
    created_at: Annotated[int, Field(alias="createdAt")]
    error: str | None = None
    inputs: Any
    message: str
    ...
    run_id: Annotated[str, Field(alias="runId")]
    runner_status: Annotated[str, Field(alias="runnerStatus")]
    snapshot_path: Annotated[str | None, Field(alias="snapshotPath")] = None
    status: WorkflowRunStatus
    updated_at: Annotated[int, Field(alias="updatedAt")]
    workflow: WorkflowSummary


class WorkflowRunProgressEvent(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
...
class CommandExecutionApprovalDecision(
    RootModel[
        CommandExecutionApprovalDecisionValue
...
class CommandExecutionRequestApprovalParams(BaseModel):
    ...
    command: str | None = None
    command_actions: Annotated[list[CommandAction] | None, Field(alias="commandActions")] = None
    cwd: AbsolutePathBuf | None = None
    item_id: Annotated[str, Field(alias="itemId")]
    network_approval_context: Annotated[
        NetworkApprovalContext | None, Field(alias="networkApprovalContext")
    ] = None
    proposed_execpolicy_amendment: Annotated[
        list[str] | None, Field(alias="proposedExecpolicyAmendment")
    ] = None
    proposed_network_policy_amendments: Annotated[
        list[NetworkPolicyAmendment] | None, Field(alias="proposedNetworkPolicyAmendments")
    ] = None
    reason: str | None = None
    started_at_ms: Annotated[int, Field(alias="startedAtMs")]
    thread_id: Annotated[str, Field(alias="threadId")]
...
class McpServerElicitationRequestParams(
    RootModel[FormMcpServerElicitationRequestParams | UrlMcpServerElicitationRequestParams]
):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    root: FormMcpServerElicitationRequestParams | UrlMcpServerElicitationRequestParams
...
class WorkflowRunProgressResponseItem(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    ...
    id: str | None = None
    type: Annotated[
        Literal["workflow_run_progress"], Field(title="WorkflowRunProgressResponseItemType")
    ]


class ThreadGoalUpdateResponseItem(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    ...
    id: str | None = None
    previous_status: ThreadGoalUpdateGoalStatus | None = None
    source: ThreadGoalUpdateEventSource
    type: Annotated[Literal["thread_goal_update"], Field(title="ThreadGoalUpdateResponseItemType")]
...
class ResponseItem(
    RootModel[
        CommandWaitResponseItem
        | CommandWriteStdinResponseItem
        | CommandExecutionNotificationResponseItem
        | WorkflowRunProgressResponseItem
        | EventCommandEventResponseItem
        | EventDrivenToolResponseItem
        | InterAgentCommunicationResponseItem
        | ThreadGoalUpdateResponseItem
        | MessageResponseItem
...
class ThreadSkillsUpdatedServerNotification(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    method: Annotated[
        Literal["thread/skills/updated"], Field(title="Thread/skills/updatedNotificationMethod")
    ]
    params: ThreadSkillsUpdatedNotification
...
class ThreadContextUsageLoadedSkills(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    loaded_count: Annotated[int, Field(alias="loadedCount", ge=0)]
    skills: list[ThreadContextUsageSkill]
    total_count: Annotated[int | None, Field(alias="totalCount", ge=0)] = None


class WorkflowRunProgressThreadItem(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    ...
    id: str
    type: Annotated[
        Literal["workflowRunProgress"], Field(title="WorkflowRunProgressThreadItemType")
    ]
...
class CollabAgentToolCallThreadItem(BaseModel):
    ...
    agents_states: Annotated[dict[str, CollabAgentState], Field(alias="agentsStates")]
    id: str
    model: str | None = None
    prompt: str | None = None
    reasoning_effort: Annotated[ReasoningEffort | None, Field(alias="reasoningEffort")] = None
    receiver_paths: Annotated[list[str], Field(alias="receiverPaths")]
    receiver_thread_ids: Annotated[list[str], Field(alias="receiverThreadIds")]
    sender_path: Annotated[str, Field(alias="senderPath")]
    sender_thread_id: Annotated[str, Field(alias="senderThreadId")]
    status: CollabAgentToolCallStatus
    timeout_ms: Annotated[int | None, Field(alias="timeoutMs")] = None
...
class CollabAgentStatusUpdateThreadItem(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    id: str
    lifecycle_status: Annotated[CollabAgentState, Field(alias="lifecycleStatus")]
    recipient_path: Annotated[str, Field(alias="recipientPath")]
    recipient_thread_id: Annotated[str | None, Field(alias="recipientThreadId")] = None
    sender_path: Annotated[str, Field(alias="senderPath")]
    sender_thread_id: Annotated[str | None, Field(alias="senderThreadId")] = None
...
class ThreadItem(
    RootModel[
        ...
        | InjectedContextThreadItem
        | AgentMessageThreadItem
        | PlanThreadItem
        | ReasoningThreadItem
        | CommandExecutionThreadItem
        | CommandExecutionNotificationThreadItem
        | CommandWaitThreadItem
        | CommandWriteStdinThreadItem
        | FileChangeThreadItem
        | McpToolCallThreadItem
        | BuiltinToolCallThreadItem
        | DynamicToolCallThreadItem
        | EventDrivenToolCallThreadItem
        | EventDrivenToolThreadItem
        | EventCommandCallThreadItem
        | EventCommandEventThreadItem
        | WorkflowRunProgressThreadItem
        | ThreadGoalUpdateThreadItem
        | CollabAgentMessageThreadItem
        | CollabAgentToolCallThreadItem
        | CollabAgentStatusUpdateThreadItem
        | WebSearchThreadItem
        | ImageViewThreadItem
...
class WorkflowAbortResponse(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    run: WorkflowRun
...
class WorkflowDescribeResponse(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
...
class ItemGuardianApprovalReviewCompletedNotification(BaseModel):
    ...
    started_at_ms: Annotated[int, Field(alias="startedAtMs")]
    target_item_id: Annotated[str | None, Field(alias="targetItemId")] = None
    thread_id: Annotated[str, Field(alias="threadId")]
    turn_id: Annotated[str, Field(alias="turnId")]
...
class ThreadContextUsage(BaseModel):
    ...
    budget_used_percent: Annotated[int | None, Field(alias="budgetUsedPercent")] = None
    categories: ThreadContextUsageCategoryBreakdown
    loaded_skills: Annotated[ThreadContextUsageLoadedSkills, Field(alias="loadedSkills")]
    tool_breakdown: Annotated[
        ThreadContextUsageToolBreakdown | None, Field(alias="toolBreakdown")
    ] = {
    ...
    total_bytes: Annotated[int, Field(alias="totalBytes")]


class ThreadContextUsageUpdatedNotification(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    context_usage: Annotated[ThreadContextUsage, Field(alias="contextUsage")]
    thread_id: Annotated[str, Field(alias="threadId")]
    token_usage: Annotated[ThreadTokenUsage, Field(alias="tokenUsage")]
    turn_id: Annotated[str, Field(alias="turnId")]
...
class ThreadContextUsageUpdatedServerNotification(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    method: Annotated[
        Literal["thread/contextUsage/updated"],
        Field(title="Thread/contextUsage/updatedNotificationMethod"),
    ]
    params: ThreadContextUsageUpdatedNotification
...
class Thread(BaseModel):
    ...
    agent_path: Annotated[
        str | None,
        Field(
            alias="agentPath", description="Optional canonical agent path assigned to this thread."
        ),
    ] = None
    ...
    context_usage: Annotated[
        ThreadContextUsage | None,
        Field(
            alias="contextUsage",
            description="Restored aggregate thread context usage, when available.",
        ),
    ] = None
    ...
    lifecycle_status: Annotated[
        ...
        Field(
            alias="lifecycleStatus", description="Current runtime lifecycle status for the thread."
        ),
    ]
    model_provider: Annotated[
        str,
    ...
    skills: Annotated[
        list[ThreadSkill] | None,
        Field(description="Aggregate thread-level skill usage observed so far."),
    ] = []
    source: Annotated[
        SessionSource,
        Field(
    ...
    token_usage: Annotated[
        ThreadTokenUsage | None,
        Field(
            alias="tokenUsage", description="Restored aggregate thread token usage, when available."
        ),
    ] = None
    turns: Annotated[
        list[Turn],
        Field(
            description="Only populated on `thread/start`, `thread/resume`, `thread/rollback`, `thread/fork`, and `thread/read` (when `includeTurns` is true) responses. `thread/start` only includes initial injected context display items. For all other responses and notifications returning a Thread, the turns field will be an empty list."
        ),
    ]
...
class ServerNotification(
    RootModel[
        ...
        | ThreadSkillsUpdatedServerNotification
        ...
        | ThreadContextUsageUpdatedServerNotification
