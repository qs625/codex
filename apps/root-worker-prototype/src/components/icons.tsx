...
export function UserIcon() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true">
      ...
      <path d="M5.5 18.5c1.2-3 3.6-4.5 6.5-4.5s5.3 1.5 6.5 4.5" />
    </svg>
  );
}
...
export function ShareIcon() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true">
      ...
      <path d="M8.9 10.9 15 8.1M8.9 13.1 15 15.9" />
    </svg>
  );
}
...
export function PaperclipIcon() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true">
      <path d="M8.5 12.5 14 7a3 3 0 1 1 4.2 4.2l-7.1 7.1a5 5 0 0 1-7.1-7.1L12 3.2" />
    </svg>
  );
}
...
export function ImageIcon() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true">
      ...
      <path d="m7 16 3.2-3.2a1.5 1.5 0 0 1 2.1 0L14 14.5l1.4-1.4a1.5 1.5 0 0 1 2.1 0L19 14.6" />
    </svg>
  );
}
...
export function SendIcon() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true">
      <path d="m4 11.8 14.6-6.3c.8-.3 1.6.4 1.4 1.3l-2.7 11.5c-.2.9-1.3 1.2-1.9.5l-3.4-4.1-3.8-.6 11.9-5.8" />
    </svg>
  );
}
...
export function BranchIcon() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true">
      <path d="M8 5.5v11a2.5 2.5 0 0 0 2.5 2.5H16" />
